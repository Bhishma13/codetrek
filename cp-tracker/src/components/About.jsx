...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
      {/* Heading */}
      <h1 className="text-4xl font-bold mb-4 text-emerald-600">About CodeTrek</h1>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
        ...
        <div className="glass-card p-8 shadow-sm">
          <h2 className="text-2xl font-semibold mb-3 text-emerald-600">📊 Real-time Data</h2>
          <p className="text-gray-600">Fetch & analyze Codeforces stats instantly.</p>
        </div>

        {/* Feature 2 */}
        <div className="glass-card p-8 shadow-sm">
          <h2 className="text-2xl font-semibold mb-3 text-emerald-600">📈 Performance Insights</h2>
          <p className="text-gray-600">See your strengths, weaknesses & improvement areas.</p>
        </div>

        {/* Feature 3 */}
        <div className="glass-card p-8 shadow-sm">
          <h2 className="text-2xl font-semibold mb-3 text-emerald-600">🎯 Goal Tracking</h2>
          <p className="text-gray-600">Set coding goals & track your improvement over time.</p>
        </div>

        {/* Feature 4 */}
        <div className="glass-card p-8 shadow-sm">
          <h2 className="text-2xl font-semibold mb-3 text-emerald-600">🔍 Compare with Friends</h2>
